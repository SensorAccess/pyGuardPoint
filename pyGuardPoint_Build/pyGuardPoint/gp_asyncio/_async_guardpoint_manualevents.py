...
class ManualEventsAPI:
    ...
    async def get_manual_events(self):
        url = "/odata/API_ManualEvents/"
        headers = {
    ...
    async def activate_manual_event_by_api_key(self, api_key):
        url = "/odata/API_ManualEvents/ActivateManualEvent"
        headers = {
            'Content-Type': 'application/json',
            'Accept': 'application/json',
        }
    ...
    async def activate_manual_event(self, manual_event):
        url = "/odata/API_ManualEvents/ActivateManualEvent"
        headers = {
            'Content-Type': 'application/json',
            'Accept': 'application/json',
