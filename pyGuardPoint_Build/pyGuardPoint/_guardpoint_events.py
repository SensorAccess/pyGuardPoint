...
from .guardpoint_dataclasses import (AlarmEvent, AccessEvent, EventOrder, AuditEvent, CommEvent, GeneralEvent,
...
class EventsAPI:
    ...
    def get_comm_events_count(self):
        return self.get_comm_events(limit=None, offset=None, count=True, orderby=EventOrder.DATETIME_DESC)

    def get_comm_events(self, limit=None, offset=None, count=False, orderby=EventOrder.DATETIME_DESC,
                        min_log_id=None):
    ...
    def get_general_events_count(self):
        return self.get_general_events(limit=None, offset=None, count=True, orderby=EventOrder.DATETIME_DESC)

    def get_general_events(self, limit=None, offset=None, count=False, orderby=EventOrder.DATETIME_DESC,
                           min_log_id=None):
    ...
    def get_technical_events_count(self):
        return self.get_technical_events(limit=None, offset=None, count=True, orderby=EventOrder.DATETIME_DESC)

    def get_technical_events(self, limit=None, offset=None, count=False, orderby=EventOrder.DATETIME_DESC,
                             min_log_id=None):
    ...
    def get_user_manual_events_count(self):
        return self.get_user_manual_events(limit=None, offset=None, count=True, orderby=EventOrder.DATETIME_DESC)

    def get_user_manual_events(self, limit=None, offset=None, count=False, orderby=EventOrder.DATETIME_DESC,
                               min_log_id=None):
    ...
    def get_extended_union_events_count(self):
        return self.get_extended_union_events(limit=None, offset=None, count=True,
                                              orderby=EventOrder.DATETIME_DESC)

    def get_extended_union_events(self, limit=None, offset=None, count=False, orderby=EventOrder.DATETIME_DESC,
                                  min_log_id=None):
        """
