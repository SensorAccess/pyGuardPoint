...
if __name__ == "__main__":
    try:
        ...
        async def test():
            ...
            print(f"GuardPoint Server Version(A Guess!! - please confirm this works): {await gp.gp_version()}")
            print(f"Signal-R enabled: {await gp.is_sigr_enabled()}")

            signal_client = await gp.get_signal_client()
