...
class App(tk.Tk):
    def __init__(self):
        ...
        self.sclLookup_threshold = ttk.Scale(self.frmLookup, variable=self.var_Lookup_thresholdLvl, from_=0, to=100, state="disabled")
        self.lblLookup_threshold = ttk.Label(self.frmLookup, relief=tk.SUNKEN, width=4, text="-", anchor=tk.CENTER, state="disabled")
        self.chkLookup_expired = ttk.Checkbutton(self.frmLookup, text="Include expired", variable=self.var_Lookup_isExpired)
        ...
        self.var_Lookup_thresholdLvl.trace_add("write", lambda *_: self.lblLookup_threshold.config(text=str(self.var_Lookup_thresholdLvl.get())))
